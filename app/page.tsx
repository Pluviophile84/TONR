...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
      {/* NAV */}
      <header className={`sticky top-0 z-30 backdrop-blur bg-[rgba(10,10,10,0.7)] ${ui.navBorder}`}>
        ...
        {mobileOpen && (
          <div id="mobile-menu" className="sm:hidden border-t border-[var(--border)] bg-[rgb(10,10,10)]">
            <div className="max-w-6xl mx-auto px-4 py-4 grid gap-3">
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <a href={TOKEN.links.buy} className="btn-cmyk btn-sm" onClick={closeMobile}>Buy</a>
                <a href={TOKEN.links.telegram} className="btn-cmyk btn-sm" onClick={closeMobile}>Telegram</a>
              </div>
            </div>
          </div>
        )}
      ...
      <section className="relative overflow-hidden sec-0">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:py-24 grid gap-6">
          ...
          <div className="flex flex-wrap gap-3 pt-2" id="cta">
            <a href={TOKEN.links.buy} className="btn-cmyk">Buy $TONR</a>
            <a href={TOKEN.links.telegram} className="btn-cmyk-ghost">Join Telegram</a>
            <a href={TOKEN.links.chart} className="btn-cmyk-ghost">View Chart</a>
          </div>
        </div>
      ...
      {/* BETA RUNNER (sec-2) */}
      <section id="beta" className={`sec-2 ${ui.sectionBorderY}`}>
        <div className="mx-auto max-w-6xl px-4 py-14 grid sm:grid-cols-3 gap-6">
          <div>
            ...
            <p className={`text-sm ${ui.sub}`}>TONR is the unofficial-official test cartridge. If TONR leaks, the machine works.</p>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <div className={`p-6 ${ui.panel}`}>
              ...
              <div className="grid grid-cols-2 gap-3">
                <a href={TOKEN.links.buy} className="btn-cmyk">Buy $TONR</a>
                <a href={TOKEN.links.chart} className="btn-cmyk-ghost">View Chart</a>
                <a href={TOKEN.links.telegram} className="btn-cmyk-ghost">Telegram</a>
                <a href={TOKEN.links.twitter} className="btn-cmyk-ghost">Twitter/X</a>
              </div>
              <p className={`mt-4 text-xs ${ui.sub}`}>* Replace placeholders with live links at launch.</p>
            </div>
          </div>
